...
import { loginUser } from '../utils/authSlice.js';
...
const Login = () => {
    ...
    return (
        ...
        <div className='bg-login min-h-screen w-full flex items-center justify-center'>
            <div className='w-140 py-30 backdrop-blur-[5px] border-2 border-gray-400 flex justify-center items-center rounded-2xl'>
                <form
                ...
                >
                    ...
                    <button
                        className='w-full tracking-[1px] bg-blue-500 text-white py-2 rounded hover:bg-blue-600 disabled:bg-blue-300'
                        type='submit'
                        disabled={loading}
                    >
                    ...
                    <div className='flex justify-center items-center gap-2 mt-5 text-[15px]'>
                        <h1 className='text-white'>Dont have any account?</h1>
                        <span className='text-[#007AFF]'><Link to={"/signup"}>Register!</Link></span>
                    </div>
                </form>
            </div>
        </div>
